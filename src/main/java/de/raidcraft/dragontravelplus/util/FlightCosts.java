...
public class FlightCosts {
    ...
    public static double getPrice(DragonStation start, DragonStation destination) {
        ...
        return Math.round(costLevel * start.getLocation().distance(destination.getLocation()) * RaidCraft.getComponent(DragonTravelPlusPlugin.class).config.pricePerBlock * 100.) / 100.;
    }
